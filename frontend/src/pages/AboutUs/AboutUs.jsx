                        ...
                        <div className="col-12 col-xl-6 mx-auto">
                            <Tilt tiltMaxAngleX={5} tiltMaxAngleY={5} className='h-100'>
                                <article className='about-content-card'>
                                    ...
                                    <p className='content-card-desc'>
                                        We highly value your loyalty and trust. To show our gratitude, we offer exclusive discounts and rewards. Choose Platinum Holiday Service for your parking needs and enjoy not just a service, but a relationship that rewards your loyalty.
                                    </p>
                                </article>
                            </Tilt>
                        </div>
