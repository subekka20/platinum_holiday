...
const FaQ = () => {
  ...
  const faqData = [
    ...
    { id: 11, question: 'How can I contact customer service?', answer: 'Email us at info@theparkingdeals.uk or call +44 7375 551666. Our support team is available during business hours.' },
            ...
            <div className="col-12 col-xl-10 mx-auto">
              <Card className="faq-main-card">
                ...
                <div className="faq-overview">
                  ...
                  <p className="faq-overview-text">Can’t find an answer? Contact our support at <strong>+44 7375 551666</strong> or <strong>info@theparkingdeals.uk</strong>.</p>
                </div>
