...
const FaQ = () => {
  ...
  const faqData = [
    ...
    { id: 11, question: 'How can I contact customer service?', answer: 'Email us at info@platinumholiday.co.uk or call +44 1234567890. Our support team is available during business hours.' },
            ...
            <div className="col-12 col-xl-10 mx-auto">
              <Card className="faq-main-card">
                ...
                <div className="faq-overview">
                  ...
                  <p className="faq-overview-text">Can’t find an answer? Contact our support at <strong>+44 1234567890</strong> or <strong>info@platinumholiday.co.uk</strong>.</p>
                </div>
                ...
                {/* <div className="faq-contact">
                  ...
                  <div className="faq-contact-buttons">
                    ...
                    <a href="mailto:info@platinumholiday.co.uk" className="faq-contact-btn email-btn">📧 Email Us</a>
                  </div>
                </div> */}
              </Card>
            </div>
